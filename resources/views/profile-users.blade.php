...
<div class="container mt-5 mb-5">
    <div class="row">
        <div class="col-12 mb-4">
            <h2 class="font-weight-bold"><i class="fas fa-user-cog mr-2"></i> Pengaturan Profil</h2>
            <p class="text-muted">Kelola informasi data diri dan keamanan akun Anda di sini.</p>
        </div>
